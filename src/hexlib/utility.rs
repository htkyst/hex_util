 ...
 */
pub fn rebuild_ranges(ranges: &mut Vec<range::AddressRange>, new_range: range::AddressRange) {
    let mut rebuild_ranges: Vec<range::AddressRange> = Vec::new();
